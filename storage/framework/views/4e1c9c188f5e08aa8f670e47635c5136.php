...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'Disjualto')); ?></title>
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-crema">
            <div>
                <a href="/">
...
<?php endif; ?>
            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-marron-claro shadow-md overflow-hidden sm:rounded-lg">
                <?php echo e($slot); ?>
...
<?php /**PATH C:\xampp\htdocs\proyectoFinal\resources\views/layouts/guest.blade.php ENDPATH**/ ?>
...
<h2 class="text-center text-2xl titulo"><?php echo app('translator')->get('app.subTituloEncargosAdmin'); ?></h2>
    ...
    <?php $__currentLoopData = $datosAdmin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemAdmin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
                ...
                <td class="border border-gray-400 p-3"><?php echo e($itemAdmin->nomProEsp); ?></td>
                <td class="border border-gray-400 p-3"><?php echo e($itemAdmin->tipoProEsp); ?></td>
                <td class="border border-gray-400 p-3"><?php echo e($itemAdmin->formatoProEsp); ?></td>
                <td class="border border-gray-400 p-3"><?php echo e($itemAdmin->descProEsp); ?></td>
            </tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
</table>

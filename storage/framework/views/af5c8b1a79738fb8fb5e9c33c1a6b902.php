    ...
    <section class="productos-section">
        ...
        <ul class="productos-list">
          <li class="producto-item">
            <h3 class="producto-nombre"><?php echo e($pedido); ?></h3>
            <p class="producto-precio">Precio: <?php echo e($pedido); ?></p>
...
</html><?php /**PATH C:\xampp\htdocs\proyectoFinal\resources\views/pedidos/visualizar.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection("main"); ?>
    ...
    <div class="bg-orange-100 w-full max-w-md mx-auto">
        ...
        <form class="bg-yellow-100 shadow-md rounded px-8 pt-6 pb-8 mb-4" action="<?php echo e(route("etiquetaPers.guardarEdicion", $etiquetaPersUpdate->idEtiq)); ?>" method="post">
            ...
            <?php echo csrf_field(); ?>
            <h1 class="mb-4 text-center text-4xl font-bold"><?php echo app('translator')->get('app.insertEtiqueta'); ?></h1>
            ...
            <input  class="mb-4 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="numTelfTienEtiq" pattern="[0-9]{9}" required value="<?php echo e($etiquetaPersUpdate->numTelfTienEtiq); ?>" required/>
            <br>
